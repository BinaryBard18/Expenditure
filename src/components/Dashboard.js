...
export default function DashBoard() {
  ...
  const analyticalData = [
    {savings : 700, month:'Jan' },
    {savings : 510, month:'Feb' },
    {savings : 1000, month:'Mar' },
    {savings : 400, month:'Apr' },
    {savings : 380, month:'May' },
    {savings : 480, month:'Jun' },
    {savings : 445, month:'Jul' },
    {savings : 100, month:'Aug' },
    {savings : 600, month:'Sep' },
    {savings : 310, month:'Oct' },
    {savings : 200, month:'Nov' },
    {savings : 300, month:'Dec' },
