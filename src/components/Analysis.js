...
export default function Analysis(){
    ...
    function handleBarItemClicked(event, d){
        ...
        console.log(monthlySummaries[index])
    }
                ...
                <div className="bar--chart--analysis--div">
                    ...
                    {monthlySummaries.length > 0 && (
                        <BarChart
                            ...
                            xAxis={[{ scaleType: 'band', dataKey: 'duration' }]}
                            series={[
                                    ...
                                    {showDetails && (
                                        <motion.div variants={transitionVariants} initial="hidden" animate="visible">
                                            ...
                                            <div className="category--percentage--spent">
                                                ...
                                                (item.categoryArray.map((element)=>(
                                                    <div className="row--div">
                                                        <div className="row">
                                                            ...
                                                            <div className="percentage--spent--data">
                                                                <p className="icon--pizza">{element.category!=='Uncategorized' ? (element.type!=="income" ? `${((element.totalAmount / item.totalExpense) * 100).toFixed(2)}%` : `${((element.totalAmount / item.totalIncome) * 100).toFixed(2)}%`) : ''}</p>
